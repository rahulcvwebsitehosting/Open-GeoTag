...
def create_master(size: int = 1024) -> Image.Image:
    ...
    shadow_draw.rounded_rectangle((174, 350, 850, 774), radius=112, fill=(0, 0, 0, 160))
    shadow_draw.rounded_rectangle((332, 270, 670, 435), radius=62, fill=(0, 0, 0, 160))
    ...
    draw.rounded_rectangle((720, 382, 814, 448), radius=24, fill=(38, 38, 38, 255))

    coral = (255, 180, 171, 255)
    draw.polygon(((512, 755), (350, 538), (674, 538)), fill=coral)
    draw.ellipse((350, 350, 674, 674), fill=coral)
    draw.ellipse((428, 428, 596, 596), fill=(0, 0, 0, 255))
